...
| `stateDiffs`        |Milestone hash          |  The changes to the addresses' balances in this transaction that a milestone confirmed on the ledger   |
| `address`          | Address hash         | List of transaction hashes that changed the addresses in this transaction|
