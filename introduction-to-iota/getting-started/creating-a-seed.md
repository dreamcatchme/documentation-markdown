...
4. After you've followed the instructions and saved the KeePass file on your computer, right click the empty space and click **Add entry**
    <img src="/introduction-to-iota/keepass-add-entry.png" alt="Click New" width="600">
...
Now that you've got a seed, you can enter it in the Trinity wallet and start sending transactions :tada: